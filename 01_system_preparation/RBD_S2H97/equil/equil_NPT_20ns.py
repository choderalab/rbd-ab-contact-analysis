...
amber_prmtop_file = "../run_tleap/rbd_s2h97.prmtop"
amber_inpcrd_file = "../run_tleap/rbd_s2h97.inpcrd"

# Set file names
output_prefix = f'/data/chodera/zhangi/vir/coronavirus/ab_systems/s2h97/output/{args.sim_number}/'
...
# Add virtual bond between chain C of S2H97 (CG of HIS311) and RBD (CG of ASP98) -- note the resids are based on tleap numbering
force = CustomBondForce('0')
force.addBond(4864, 1503, [])
