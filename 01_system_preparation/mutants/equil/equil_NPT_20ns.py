...
parser.add_argument('dir', type=str, help='number of dir')
...
amber_prmtop_file = f"../run_tleap/{args.dir}/7jx3_s309_mutant.prmtop"
amber_inpcrd_file = f"../run_tleap/{args.dir}/7jx3_s309_mutant.inpcrd"

# Set file names
output_prefix = f'/data/chodera/zhangi/vir/coronavirus/ab_systems/7jx3_s309_mutants/{args.dir}/'
